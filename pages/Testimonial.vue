<template>
  <!-- global container -->
  <div class="container mx-auto max-w-7xl p-2 md:p-10 bg-gray-200">
    <!-- grid container -->
    <div class="grid gap-6 grid-cols-1 text-white md:grid-cols-4 md:grid-rows-2">
      ...
      <div class="relative p-10 rounded-xl bg-purple-700 md:col-span-2">
        <!-- quotes image -->
        <img src="~/assets/testimonial/bg-pattern-quotation.svg" alt=""
          class="absolute top-3 right-10 scale-125 md:top-7 md:right-24 md:scale-150">
        <!-- box header -->
        <div class="flex z-10 space-x-4">
          <img src="~/assets/testimonial/image-daniel.jpg" alt="" class="w-10 h-10 rounded-full ring-2 ring-purple-300">
          <div class="text-sm">
            <h4 class="opacity-90">Daniel Clifford</h4>
            <p class="opacity-50">Verified Gratuate</p>
          </div>
        </div>
        <!-- large text -->
        ...
        <!-- small text -->
        <p class="mt-6 opacity-50 line-clamp-3 md:line-clamp-5">
          ...
          startup. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione vero repudiandae, quasi atque
          officiis eum consectetur odio amet dolorem deleniti repellat expedita aut sunt laudantium cum itaque nam
          voluptatum quod! Quo totam sequi omnis deserunt? Sit nam molestiae excepturi, perspiciatis labore deleniti
          eum, eligendi quisquam quod sed nobis exercitationem tempora! Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Maiores inventore in fugit, laborum a illo quaerat animi voluptatum assumenda illum nisi
          eius placeat earum rerum dolore ab quod sed repellendus doloremque saepe! Maiores quas officia veritatis dicta
          voluptatem magni, distinctio earum facere doloribus porro? Voluptatibus dolore nemo repudiandae eum quaerat? "
        </p>
      </div>
      <!-- box 2 -->
      <div class="p-10 rounded-xl bg-gray-600">
        ...
        <div class="flex space-x-4">
          <img src="~/assets/testimonial/image-jonathan.jpg" alt=""
      ...
      <div class="hidden p-10 rounded-xl text-gray-900 bg-white md:block md:row-span-2">
        <!-- box header -->
        <div class="flex space-x-4">
          <img src="~/assets/testimonial/image-kira.jpg" class="w-10 h-10 rounded-full ring-2 ring-purple-300">
          <div class="text-sm">
            <h4 class="opacity-90">Kiera Whittle</h4>
            <p class="opacity-50">Verified Gratuate</p>
          </div>
        </div>
        <!-- large text -->
        ...
        <!-- small text -->
        <p class="mt-6 opacity-50 line-clamp-3 md:line-clamp-none">
      ...
      <!-- box 4 -->
      <div class="p-10 rounded-xl bg-gray-900 text-white">
        <!-- box header -->
        <div class="flex space-x-4">
          <img src="~/assets/testimonial/image-jeanette.jpg" alt=""
            class="w-10 h-10 rounded-full ring-2 ring-purple-300">
          <div class="text-sm">
      ...
      <div class="p-10 rounded-xl bg-gray-900 md:col-span-2">
        <!-- box header -->
        <div class="flex space-x-4">
          <img src="~/assets/testimonial/image-patrick.jpg" alt=""
            class="w-10 h-10 rounded-full ring-2 ring-purple-300">
          <div class="text-sm">
      ...
      <div class="p-10 rounded-xl text-gray-900 bg-white md:hidden">
        ...
        <!-- small text -->
        <p class="mt-6 opacity-50 line-clamp-3">
          "Before joining the bootcamp, I've never written a line of code. I
          needed some structure from professionals who can help me learn
          programming step by step. I was encouraged to enroll by a former
          student of theirs who can only say wonderful things about the
